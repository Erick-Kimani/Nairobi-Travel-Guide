...
<template>
  <div class="detail-root">
    ...
    <div class="hero">
      ...
      <!-- ── bottom title block ── -->
      <div class="hero-bottom" v-if="service">

        <!-- rating row -->
        <div class="star-row">
          <v-icon v-for="n in 5" :key="n" size="14" class="star-icon">mdi-star</v-icon>
          <span class="star-label">BEST Safari</span>
        </div>
        ...
        <div class="hero-eyebrow">
          ...
          <span>Premium Safari</span>
          <span class="eyebrow-sep">·</span>
          <span>Kenya</span>
          <span class="eyebrow-sep">·</span>
          <span>Wildlife Experience</span>
        </div>
        ...
        <div class="hero-tags">
          ...
          <span class="htag">
            <v-icon size="12">mdi-paw</v-icon> Big Five
          </span>
          <span class="htag">
            <v-icon size="12">mdi-binoculars</v-icon> Game Drives
          </span>
          <span class="htag">
            <v-icon size="12">mdi-leaf</v-icon> Eco-Friendly
          </span>
        </div>
      </div>
    ...
    <!-- ░░░ LIFTED CONTENT ░░░ -->
    <div class="content-lift" v-if="service">
      <div class="content-card">
        ...
        <div class="card-inner">
          ...
          <!-- ── LEFT: About ── -->
          <div class="card-text">
            <p class="section-label">About this safari</p>
            ...
            <div class="highlights">
              <div class="highlight-item">
                <div class="hi-icon-wrap">
                  <v-icon size="18" class="hi-icon">mdi-paw</v-icon>
                </div>
                <div>
                  <div class="hi-val">Big Five</div>
                  <div class="hi-key">Wildlife</div>
                </div>
              </div>
              <div class="highlight-item">
                <div class="hi-icon-wrap">
                  <v-icon size="18" class="hi-icon">mdi-jeepney</v-icon>
                </div>
                <div>
                  <div class="hi-val">4×4</div>
                  <div class="hi-key">Game Drive</div>
                </div>
              </div>
              <div class="highlight-item">
                <div class="hi-icon-wrap">
                  <v-icon size="18" class="hi-icon">mdi-account-cowboy-hat</v-icon>
                </div>
                <div>
                  <div class="hi-val">Expert</div>
                  <div class="hi-key">Guides</div>
                </div>
              </div>
              <div class="highlight-item">
                <div class="hi-icon-wrap">
                  <v-icon size="18" class="hi-icon">mdi-camera</v-icon>
                </div>
                <div>
                  <div class="hi-val">Photo</div>
                  <div class="hi-key">Friendly</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-action">
            ...
            <p class="section-label">Plan Your Safari</p>
            ...
            <div class="trust-badges">
              ...
              <div class="trust-badge">
                <v-icon size="15" class="tb-icon">mdi-leaf-circle-outline</v-icon>
                <span>Eco-Certified Operator</span>
              </div>
              <div class="trust-badge">
...
.hero-scrim {
  ...
  background:
    ...
    linear-gradient(160deg,
      transparent          45%,
      rgba(60,120,0,0.10) 100%);  /* subtle green tint for wilderness feel */
}
