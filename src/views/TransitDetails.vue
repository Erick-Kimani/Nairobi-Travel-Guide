...
const numericPrice = computed(() => {
  ...
  const num = parseFloat(String(transit.value.price).replace(/[^0-9.]/g, ''))
...
<template>
  <div class="detail-root">
    ...
    <div class="hero">
      ...
      <div class="hero-topbar">
        ...
        <div class="hero-breadcrumb">
          ...
          <span class="bc-current">{{ transit?.name }}</span>
        </div>
      </div>

      <!-- ── bottom title block ── -->
      <div class="hero-bottom" v-if="transit">

        <!-- star rating row -->
        <div class="star-row">
          <v-icon v-for="n in 5" :key="n" size="14" class="star-icon">mdi-star</v-icon>
          <span class="star-label">5-Star Service</span>
        </div>

        <h1 class="hero-title">{{ transit.name }}</h1>
        ...
        <div class="hero-tags">
          ...
          <span class="htag">
            <v-icon size="12">mdi-crown</v-icon> Premium
          </span>
          <span class="htag">
            <v-icon size="12">mdi-clock-fast</v-icon> On-Time
          </span>
        </div>
      </div>
    ...
    <!-- ░░░ LIFTED CONTENT ░░░ -->
    <div class="content-lift" v-if="transit">
      <div class="content-card">
        ...
        <div class="card-inner">
          ...
          <!-- ── LEFT: About ── -->
          <div class="card-text">
            <p class="section-label">About this service</p>
            <p class="card-desc">{{ transit.description }}</p>
          ...
          <div class="card-action">
            ...
            <p class="section-label">Book Your Ride</p>
